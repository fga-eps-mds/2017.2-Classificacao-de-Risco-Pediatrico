# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-11-09 16:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(blank=True, choices=[(0, 'Sexo indefinido'), (1, 'Feminino'), (2, 'Masculino')], default=0, verbose_name='Classification')),
                ('age_range', models.IntegerField(choices=[(0, 'Faixa etária indefinida'), (1, '0 até 28 dias'), (2, '29 dias à 3 meses'), (3, '3 meses à 2 anos'), (4, '2 anos à 10 anos'), (5, 'Acima de 10 anos')], default=0, verbose_name='Classification')),
            ],
        ),
    ]
